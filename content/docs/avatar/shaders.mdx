...
![Scene showing incorrect shader rending](/img/avatars/23.png)

- Select each material in your avatar's folder and change its shader to use Poiyomi Pro URP.

![Scene Window showing materials selected and Poiyomi shaders being added](/img/avatars/24.png)

- After making the changes, your avatar should render as expected.

![Scene window showing avatar with working Poiyomi shaders](/img/avatars/25.png)
